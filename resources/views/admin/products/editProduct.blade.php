    ...
    <form action="{{ route('edit-product',['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="mb-3 col-md-4">
          ...
          <input type="text" id="disabledTextInput" class="form-control" value="{{ $product->name }}" name="name"
            required>
        </div>
        <div class="mb-3 col-md-4">
        ...
        <div class="mb-3 col-md-4">
          ...
          <input type="text" id="disabledTextInput" class="form-control" name="description"
            value="{{ $product->description }}" required>
        </div>
        <div class="mb-3 col-md-4">
          <label for="disabledTextInput" class="form-label">Product Price</label>
          <input type="number" id="disabledTextInput" class="form-control" name="price" value="{{ $product->price }}"
            required>
        </div>
        <div class="mb-3 col-md-4">
          <label for="disabledTextInput" class="form-label">Product Quantity</label>
          <input type="number" id="disabledTextInput" class="form-control" name="quantity"
            value="{{ $product->quantity }}" required>
        </div>
        <div class="mb-3 col-md-4">
          <label for="disabledTextInput" class="form-label">Shipping Area</label>
          <input type="text" id="disabledTextInput" class="form-control" name="shipping_area"
            value="{{ $product->shipping_area }}" required>
        </div>
